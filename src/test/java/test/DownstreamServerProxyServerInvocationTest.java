...
@SpringBootTest(classes = {WebClientApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
    properties = {
      "endpoint.downstreamUrl=http://downstreamhost:8088/api",
      "endpoint.proxyUrl=http://localhost:8090",
      "endpoint.oauth2Url=http://localhost:8090/oauth2" })
@DirtiesContext(classMode = ClassMode.AFTER_EACH_TEST_METHOD)
public class DownstreamServerProxyServerInvocationTest {
